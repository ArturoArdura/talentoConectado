...
$sql = "INSERT INTO registrosTalentos (nombre, edad, email, telefono, discapacidad, motivo)
VALUES ('$name', '$edad', '$email', '$numero', '$subject', '$message')";
